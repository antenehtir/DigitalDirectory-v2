# Codex Task 49: Public Listing Read Integration Plan
...
Create a documentation-only plan for how the first read-only Supabase-backed public listing integration should work later, including facilities, doctors, pharmacies, diagnostics providers, services, specialties, locations, filtering/search behavior, static seed fallback, loading/error states, public/private field protection, and no-auth public access.
...
- docs/CodexTask-49-PublicListingReadIntegrationPlan.md
...
Task 49 should define the first read-only public listing integration plan before any actual Supabase read code, package installation, SQL, migration, or UI change is created.
