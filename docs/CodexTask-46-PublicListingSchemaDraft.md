# Codex Task 46: Public Listing Schema Draft
...
Create a documentation-only schema draft for the first public listing database structure, including facilities, doctors, pharmacies, diagnostics providers, services, specialties, locations, relationships, public contact channels, listing status, verification status, public/private fields, and seed data mapping.
...
- docs/CodexTask-44-SupabaseIntegrationPhase1.md
...
Task 46 should define the public listing schema draft before any SQL, migration, Supabase table, or integration code is created.
