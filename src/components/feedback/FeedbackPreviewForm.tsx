const feedbackFields = [
  ...
  { label: "Related page or listing", placeholder: "Optional page or provider name" },
];
  ...
  return (
    <section className="rounded-lg border border-border bg-card p-5 shadow-sm sm:p-6">
      ...
      <p className="mt-2 text-sm leading-6 text-muted-foreground">
        Share enough detail for the team to understand what should be improved
        or reviewed.
      </p>

      <div className="mt-5 grid gap-4" role="form" aria-label="Feedback form">
