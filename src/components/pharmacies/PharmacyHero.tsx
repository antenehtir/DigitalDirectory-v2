    ...
    <header className="rounded-lg border border-border bg-card p-5 shadow-sm sm:p-6 lg:p-8">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-base leading-7 text-muted-foreground">
          Browse frontend-only pharmacy listings, prescription pickup concepts,
          and future delivery-ready workflow previews without inventory,
          ordering, payments, uploads, or real medication search.
        </p>
      </div>
    </header>
  );
