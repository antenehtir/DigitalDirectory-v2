export function CorrectionsHero() {
  return (
    <header className="rounded-lg border border-border bg-card p-5 shadow-sm sm:p-6 lg:p-8">
      <div className="max-w-3xl">
        ...
        <h1 className="text-3xl font-semibold leading-tight text-foreground sm:text-4xl">
          Help keep healthcare information accurate.
        </h1>
        <p className="mt-4 text-base leading-7 text-muted-foreground">
          Preview the future correction request flow for outdated provider,
          facility, pharmacy, laboratory, and diagnostic center details.
        </p>
      </div>
    </header>
  );
