const previewFields = [
  ...
  { label: "Contact method", placeholder: "Phone or email preview" },
  ...
  return (
    <section className="rounded-lg border border-border bg-card p-5 shadow-sm sm:p-6">
      ...
      <p className="mt-2 text-sm leading-6 text-muted-foreground">
        Static fields show the future support request shape. Nothing is sent,
        stored, uploaded, emailed, or turned into a support ticket.
      </p>

      <div className="mt-5 grid gap-4" role="form" aria-label="Contact preview form">
