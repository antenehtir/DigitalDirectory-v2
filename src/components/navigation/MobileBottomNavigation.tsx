      ...
      <div className="mx-auto grid max-w-md grid-cols-5 gap-1">
        {mobileNavigationItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              className={`flex min-h-16 flex-col items-center justify-center rounded-md px-1 text-xs font-medium transition-colors hover:bg-muted hover:text-primary ${
            ...
            >
              <span
                className={`mb-1 flex size-5 items-center justify-center rounded text-[10px] font-bold ${
                  isActive
